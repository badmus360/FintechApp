...
public class GlobalExceptionHandler {
    ...
    //Catches unauthorized access exception thrown by Spring Security even before the controller is executed
    ...
    @ResponseBody
    public ApiResponse<String> handleInvalidCredentialException(InvalidCredentialsException ex){
        logger.error(ex.getMessage());
        return new ApiResponse<>("Failed", "Error: " + ex.getMessage(), null);
    }
}
